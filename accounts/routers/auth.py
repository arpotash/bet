...
from accounts.dependencies import UserManager
from accounts.models import User
from accounts.schemas.auth import (UserAuth, UserRegister, user_pydantic_model)
from accounts.utils import (generate_hashed_password, generate_jwt_token, generate_verify_token,
...
async def login(login_body: UserAuth):
    try:
...
async def get_user(user: User = Depends(UserManager.get_user)):
    return user
